...
AtlasQuest.data = {
	...
	[22] = {
		...
		[2] = {
			...
			[2] = {
				...
				["id"] = 1051,
				["attain"] = 25,
				["aim"] = "Return Vorrel Sengutz's wedding ring to Monika Sengutz in 塔伦米尔.",
	...
	[23] = {
		[1] = {
			...
			[7] = {
				["note"] = "You can find The Deed to Caer Darrow at "..NORMAL.."[12]"..WHITE..", The Deed to Brill at "..NORMAL.."[7]"..WHITE..", The Deed to 塔伦米尔 at "..NORMAL.."[4]"..WHITE.." and The Deed to Southshore at "..NORMAL.."[1]"..WHITE..".",
				["id"] = 5343,
				["attain"] = 52,
				["aim"] = "Venture to the Scholomance and recover the Barov family fortune. Four deeds make up this fortune: The Deed to Caer Darrow; The Deed to Brill; The Deed to 塔伦米尔; and The Deed to Southshore. Return to Weldon Barov when you have completed this task.",
		...
		[2] = {
			...
			[7] = {
				...
				["id"] = 5341,
				["attain"] = 52,
				["aim"] = "Venture to the Scholomance and recover the Barov family fortune. Four deeds make up this fortune: The Deed to Caer Darrow; The Deed to Brill; The Deed to 塔伦米尔; and The Deed to Southshore. Return to Alexi Barov when you have completed this task.",
				["title"] = "Barov Family Fortune",
	...
	[36] = {
		...
		[2] = {
			[1] = {
				...
				["id"] = 7241,
				["attain"] = 51,
				["aim"] = "Venture to Alterac Valley, located in the Alterac Mountains. Find and speak with Warmaster Laggrond - who stands outside the tunnel entrance - to begin your career as a soldier of Frostwolf. You will find Alterac Valley north of 塔伦米尔 at the base of the Alterac Mountains.",
	...
	[48] = {
		[1] = {
			...
			[2] = {
				["note"] = "黑心大王在副本内[7]号位置\n\n前置任务从瓦斯塔格·铁颚(湿地 - 米奈希尔港; "..NORMAL.."[10.1 / 56.9]"..WHITE..")处开始.",
				["id"] = 41757,
				["attain"] = 23,
			...
			[3] = {
				["note"] = "索里奥斯馆长(铁炉堡 - 探险者大厅; "..NORMAL.."[71.8 / 16.1]"..WHITE..").",
				["id"] = 41754,
				["attain"] = 22,
				["aim"] = "将红标石板交给铁炉堡图书馆的一位历史学家",
				["title"] = "红标谎言",
				["location"] = "红标石板(副本内[5]号位置)",
				["followup"] = "红标谎言",
				["level"] = 28,
			},
			[4] = {
				["note"] = "孤峰在副本内"..NORMAL.."[1]"..WHITE.."号位置.",
				["id"] = 41750,
				["attain"] = 20,
			...
			[6] = {
				["note"] = "希瑞斯塔萨在副本内"..NORMAL.."[9]"..WHITE.."号位置.",
				["id"] = 41751,
				["attain"] = 24,
				["aim"] = "帮尼迪赞兹解救他的兄弟希瑞斯塔萨",
				["title"] = "龙喉之巢",
		...
		[2] = {
			[1] = {
				["note"] = "穴织女王在副本内 "..NORMAL.."[2]"..WHITE.." 号位置.",
				["id"] = 41752,
				["attain"] = 21,
				["aim"] = "在龙喉居所击杀穴织女王,并将他的毒囊交给落锤镇的奥库尔",
				["title"] = "穴织精萃",
				["location"] = "奥库尔 (阿拉希高地 - 落锤镇 "..NORMAL.."[73.9 / 34.2]"..WHITE..")",
				["level"] = 27,
			},
			[2] = {
				["note"] = "永恒之火在副本内 "..NORMAL.."[4]"..WHITE.." 号位置.",
				["id"] = 41753,
				["attain"] = 24,
				["aim"] = "从龙喉居所取回永恒之火并将其交给塔伦米尔的莎拉·布拉森.",
				["title"] = "永不熄灭的烈焰",
